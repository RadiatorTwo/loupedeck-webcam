namespace Loupedeck.WebcamPlugin.Actions
{
    ...
    public class RollAdjustment : ActionEditorAdjustment
    {
        ...
        public RollAdjustment()
            : base(hasReset: false)
        {
            this.DisplayName = "Roll";
            this.Description = "Set the Roll for the selected Webcam";
        ...
        private void OnActionEditorControlValueChanged(Object sender, ActionEditorControlValueChangedEventArgs e)
        {
            ...
            {
                e.ActionEditorState.SetDisplayName($"Set Roll for Webcam {e.ActionEditorState.GetControlValue(ListboxControlName)}");
            }
        }
            ...
            if (this._videoSource == null)
            {
                ...
                foreach (FilterInfo device in videoDevices)
                {
                    if (device.Name.Equals(devicename))
                    {
                        ...
                        this._videoSource.GetCameraPropertyRange(CameraControlProperty.Roll, out this.minValue, out this.maxValue, out this.defaultValue, out this.stepSize, out cameraControlFlags);
                        this._videoSource.GetCameraProperty(CameraControlProperty.Roll, out this.currentValue, out cameraControlFlags);
        ...
        private void SetValue() => this._videoSource.SetCameraProperty(CameraControlProperty.Roll, this.currentValue, CameraControlFlags.Manual);
